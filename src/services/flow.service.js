...
export const registrarTarjeta = async ({ customerId, plan }) => {
  const params = {
    apiKey: FLOW_API_KEY,
    customerId: customerId,
    url_return: `https://team-crafter-backend-production.up.railway.app/api/v1/user/resultado-registro-tarjeta?plan=${plan}`,
  };
